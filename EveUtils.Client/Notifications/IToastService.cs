...
/// tests, early startup) <c>Show</c> is a silent no-op. Toasts land in the corner the user configured unless a caller
/// names one.
/// </summary>
public interface IToastService
{
    ...
    /// <see cref="Show(string, string?, ToastKind, TimeSpan?, ToastPosition?)"/>.
    /// </summary>
