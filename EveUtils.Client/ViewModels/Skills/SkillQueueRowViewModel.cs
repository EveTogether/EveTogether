...
public sealed partial class SkillQueueRowViewModel(
    int position, int skillTypeId, string skillName, int finishedLevel, string groupName, bool isTraining,
    string thisLevelText, string endsText, string fromNowText) : ObservableObject
{
    ...
    public string PipsText { get; } = new string('■', finishedLevel) + new string('□', 5 - finishedLevel);
