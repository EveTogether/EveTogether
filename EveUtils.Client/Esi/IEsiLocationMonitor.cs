...
/// ESI, and so the gamelog does not have to know what any reader makes of a location.
///
...
/// </summary>
public interface IEsiLocationMonitor
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="characterName">Shown to the pilot when the location cannot be read, so the message names who.</param>
    void Watch(int characterId, string characterName, Action<EsiLocationReading> onReading);
