...
/// remove; <paramref name="CharacterId"/> is what ESI keys an in-game kick by. The coupled in-game ids come from the
/// fleet header the screen already holds — both null means "not coupled", which is the case where the second
