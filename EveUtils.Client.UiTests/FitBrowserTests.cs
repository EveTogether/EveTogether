...
public class FitBrowserTests
{
    ...
    public async Task FitBrowser_Renders_WithSelectedDetail()
    {
        ...
        frame!.Save(System.IO.Path.Combine(System.IO.Path.GetTempPath(), "eveutils-fit-browser.png"), new Avalonia.Media.Imaging.PngBitmapEncoderOptions());
    }
    ...
    public async Task FitBrowser_Renders_WithManageActions()
    {
        ...
        var frame = window.CaptureRenderedFrame();
        Assert.NotNull(frame);
        frame!.Save(System.IO.Path.Combine(System.IO.Path.GetTempPath(), "eveutils-fit-browser-manage.png"), new Avalonia.Media.Imaging.PngBitmapEncoderOptions());
    }
    ...
    public async Task FitMetadataDialog_Renders()
    {
        ...
        Assert.NotNull(frame);
        frame!.Save(System.IO.Path.Combine(System.IO.Path.GetTempPath(), "eveutils-fit-metadata-dialog.png"), new Avalonia.Media.Imaging.PngBitmapEncoderOptions());
        dialog.Close();
    }
