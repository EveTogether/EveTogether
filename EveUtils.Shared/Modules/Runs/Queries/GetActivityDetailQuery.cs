...
/// loot, bounty and enemy rows. Reads the runs the summary was built from directly, never through
/// <see cref="GetRunningRunLootQuery"/> or any other lookup that guesses which run is meant (ET-160).</summary>
