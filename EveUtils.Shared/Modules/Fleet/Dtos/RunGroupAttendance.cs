...
/// <summary>
/// The fleet commander's attendance list for a homefront (ET-230): every character on the roster with a tick for
/// "in site at completion" and why, plus the pilots on no roster at all. The wire payload of
/// <see cref="Events.FleetRunAttendanceEvent"/>; the commander is the envelope's own character, never a field of this.
///
