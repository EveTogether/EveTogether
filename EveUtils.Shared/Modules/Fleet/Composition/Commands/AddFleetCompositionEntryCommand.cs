...
/// Returns the new entry's id. <see cref="SkillMinimums"/> is the doctrine skill minimum; null or empty = none.</summary>
public sealed record AddFleetCompositionEntryCommand(
    long RoleId,
    FitReference Fit,
    int? EntryMinCount,
    int ActingCharacterId,
    IReadOnlyList<SkillMinimum>? SkillMinimums = null) : ICommand<Result<long>>;
