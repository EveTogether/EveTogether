...
/// library fit being deleted. <see cref="SkillMinimums"/> is the doctrine skill minimum on top of what the fit
/// requires (owned rows, replaced as a whole by an edit).
/// </summary>
public sealed class FleetCompositionEntry
{
    ...
    public List<FleetCompositionEntrySkillMinimum> SkillMinimums { get; set; } = [];
}
