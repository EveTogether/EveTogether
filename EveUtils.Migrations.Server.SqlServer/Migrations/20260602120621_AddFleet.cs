        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ToTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ...
                    Motd = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    IsFreeMove = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TakesFleetWarp = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
