...
### Added
- **An activity can now be deleted, from a quiet link at the bottom of its detail screen.** It asks you
  to confirm first, naming the site, how many of your own runs go and how much ISK — and, if it was
