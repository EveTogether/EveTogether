        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharacterName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    RefreshTokenCipher = table.Column<byte[]>(type: "BLOB", nullable: false),
                    RefreshTokenNonce = table.Column<byte[]>(type: "BLOB", nullable: false),
                    RefreshTokenTag = table.Column<byte[]>(type: "BLOB", nullable: false),
