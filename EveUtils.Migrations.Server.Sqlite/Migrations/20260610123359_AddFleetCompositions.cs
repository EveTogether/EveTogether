        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CompositionId = table.Column<long>(type: "INTEGER", nullable: false),
                    RoleName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    GroupMinCount = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntryMinCount = table.Column<int>(type: "INTEGER", nullable: true),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    Fit_ShipTypeId = table.Column<int>(type: "INTEGER", nullable: false),
                    Fit_FitName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    Fit_RawJson = table.Column<string>(type: "TEXT", nullable: false),
                    Fit_ContentHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Fit_LocalFittingId = table.Column<int>(type: "INTEGER", nullable: true),
                    Fit_ServerSharedFitId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
